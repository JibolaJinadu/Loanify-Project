    ...
    <div className='Notification-card'>
        <div className='email-container'>
            <div className='Text_holder'>
                ...
                <p>Get emails to find out what happens when you are not online.You can turn them off</p>
            </div> 
        ...
        <div className='Loan-container'>
          <div className='Text_holder'>
            ...
            <p>Get push notifications in-app to find out what appens wen you're online. You can turn them off.</p>
          </div>
