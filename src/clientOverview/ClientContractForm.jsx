              ...
              <div>
                ...
                <p>
                  ...
                  <input
                    ...
                    className="form-text"
                  ></input>{' '}
                  (Arbitration/mediation/negotiation) (Circle one) in accordance
                ...
                <p>
                  ...
                  control and supersede any course of performance and/or usage
                  of the trade inconsistent with any of the terms hereof.
                </p>
                <h4>OWNERSHIP</h4>
                <p>
                  - The Parties agree that this Agreement is not transferable
                  unless a written consent is provided by both Parties of this
                  Agreement.
                </p>
                <h4>SEVERABILITY</h4>
                <p>
                  - In an event where any provision of this Agreement is found
                  to be void and unenforceable by a court of competent
                  jurisdiction, then the remaining provisions will remain to be
                  enforced in accordance with the Parties’ intention.
                </p>
                <h4>SIGNATURE AND DATE</h4>
                <p>
                  - The Parties hereby agree to the terms and conditions set
                  forth in this Agreement and such is demonstrated throughout by
