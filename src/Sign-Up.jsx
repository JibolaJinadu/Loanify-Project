...
const SignUp = () => {
  ...
  const handleChange = (event) => {
    ...
    setErrorFields((prevErrors) => ({ ...prevErrors, [id]: validateField(id, value) }));
  };
      ...
      <div className="container">
        ...
        <section className="right-div">
          ...
          <div className="rd-container-3">
            ...
            <p className="rd-container-4"> Already have an Account? <a href="https://support.google.com">Log in</a></p>
          </div>
        </section>
      </div>
    </>
